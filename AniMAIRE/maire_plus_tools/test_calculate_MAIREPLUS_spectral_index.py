...
from .calculate_MAIREPLUS_spectral_index import calculate_MAIREPLUS_spectral_index


class TestCalculateMaireplusSpectralIndex(unittest.TestCase):
    """Test cases for calculate_MAIREPLUS_spectral_index function."""
    
    @patch('src.maire_plus_tools.tools.calculate_MAIREPLUS_spectral_index.NeutronMonitor')
    @patch('src.maire_plus_tools.tools.calculate_MAIREPLUS_spectral_index.calculate_spectral_index_for_target_ratio')
